...
public class Main {
 ...
 /*to put here*/                          System.out.println( (i+1) +"- "+ListDrivers.ListOfDrivers.get(i).getUsername() + " & his State is " +ListDrivers.ListOfDrivers.get(i).getSTATE());
                                ...
                                String str=input.next();
                                Administrator.getInstance().setCurrentDay(str);
                            }
                            else if(choose1=='6'){
                                System.out.print("Enter Current Date : ");
                                String str=input.next();
                                Administrator.getInstance().setCurrentDate(str);
                            }
                            else if (choose1 == '7') break;
                            else
                                    ...
                                    if(choose2=='1'){
                                        if (driver.getNotification().size()==0){
                                            ...
                                            for (int i=0;i<driver.getNotification().size();i++){
                                                System.out.println((i+1)+"- " + driver.getNotification().get(i));
                                            }

                                            System.out.print("Enter Number Of Customer To Send Offer : ");
                                            int number = input.nextInt();
                                            number--;
                                            String username=driver.getNotification().get(number);
                                            Customer c=new Customer();
                                            for(int i=0;i<ListCustomers.ListOfCustomer.size();i++){
                                                if(ListCustomers.ListOfCustomer.get(i).getUsername().equals(username)) {
                                                    c=ListCustomers.ListOfCustomer.get(i);
                                                    break;
                                                }
                                            }
                                            System.out.print("Enter Offer : ");
                                            double price = input.nextDouble();
                                            driver.addOffer(c,price );
                                        }
                                    }
                                    else if(choose2=='2'){
                                        ...
                                        driver.checkArriving();
                                    }
                                    else if(choose2=='7'){
                                        driver.checkFinishing();
                                    }
                                    else if(choose2=='8'){
                                        break;
                                    }
                ...
                case '3':{
                    ...
                    switch (choose1){
                        ...
                        case '1':{
                            ...
                            System.out.print("Enter Birthdate ex:(15/7) : ");
